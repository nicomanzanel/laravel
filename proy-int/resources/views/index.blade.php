...
<head>
    ...
    <title>Inicio - Tecno Movil</title>
</head>
<body>
    ...
    <section>
        ...
        <img src=""/css/diapositiva-01.jpg" class="d-block w-100" alt="1">
        </div>
        <div class="carousel-item">
        <img src=""/css/diapositiva-03.jpg" class="d-block w-100" alt="2">
        </div>
        <div class="carousel-item">
        <img src=""/css/diapositiva-04.webp" class="d-block w-100" alt="3">
        </div>
        </div>
